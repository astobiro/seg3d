...
class Unet3Dmodel:
    ...
    def save_identification(self):
        file = open(self.resultpath + self.config.IDENTIFICATION + ".txt", "r")
    ...
    def my_unet3D(self, input_shape=(160,160,16,4),output_channels=4):
        ...
        encoderBlock32 = Activation(LeakyReLU())(encoderBlock32)
        ...
        decoderBlock128 = Activation(LeakyReLU())(decoderBlock128)
        ...
        decoderBlock64 = Activation(LeakyReLU())(decoderBlock64)
        ...
        decoderBlock32 = Activation(LeakyReLU())(decoderBlock32)
    ...
    def evaluate_model_per_patient(self,n_steps=None,shuffle=False):
        ...
        for i in range(len(pred_list)):
            ...
            for j in range(len(self.config.segmentation_name_map)):
                ...
                average_metrics["count"][j] = count[indexer[pred_list[i]]]
